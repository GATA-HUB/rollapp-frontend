...
const Page = () => {
  ...
  return (
    <div className="page">
      <div className="w-full grid grid-cols-2 2xl:grid-cols-4 gap-4">
        {/* Loyalty */}
        <div className="w-full flex flex-col gap-2 col-span-2 2xl:col-span-1">
          ...
          <Link href="https://gatahub-loyalty.netlify.app/">
            <div className="group relative w-full h-full max-h-[87.48px] flex flex-col gap-1 justify-end p-4 rounded-lg gradient-background border-[1px] border-white border-opacity-10 overflow-hidden cursor-pointer">
              <div className="flex lg:flex-col h-full justify-between lg:justify-start lg:group-hover:mb-[86px] z-10 gap-8 transition-all duration-300 ease-in-out">
                <div className="flex flex-col gap-1">
                  <h5>total points</h5>
                  <h1>1000</h1>
                </div>
                <div className="flex gap-2 items-center justify-end lg:justify-center w-full min-h-[54px]">
              ...
              <div className="absolute right-0 mb-[-18px] lg:group-hover:mb-[-48px] transition-all duration-300 ease-in-out">
                <Image
                  width={192}
                  height={131}
                  alt=""
        ...
        {/* Assets */}
        <div className="flex flex-col gap-2 col-span-2 2xl:col-span-3">
          <h2 className="text-white">Assets</h2>

          <div className="flex flex-col lg:grid lg:grid-cols-4 gap-4">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-4 col-span-2">
